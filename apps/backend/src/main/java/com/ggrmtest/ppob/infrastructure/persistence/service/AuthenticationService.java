...
public class AuthenticationService {
    ...
    public UserRegisterDTO customerSignup(UserRegisterDTO input) {
			...
			var inputDto = input.setPassword(passwordEncoder.encode(input.getPassword())).setRole(Role.USER);
    ...
    public UserRegisterDTO sellerSignup(UserRegisterDTO input) {
			...
			var inputDto = input.setPassword(passwordEncoder.encode(input.getPassword())).setRole(Role.ADMIN);
    	userRepository.save(inputDto.toUser(new User()));
			return inputDto;
    }
